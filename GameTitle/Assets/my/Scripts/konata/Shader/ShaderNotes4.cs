...
/// </summary>
public class ShaderNotes4 : MonoBehaviour
{
    ...
    void Start()
    {
        material = GetComponent<Renderer>().material;                   //シェーダー参照用
        ...
        for (int i = 0; i < notesArr.Length; i++)
        {
            ...
            string str = "_Pos" + i.ToString();
            material.SetFloat(str, startPos.z * -1); //シェーダー「_Pos」の初期化
        }
    }
    ...
    void Update()
    {
        ...
        for (int i = 0; i < notesArr.Length; i++)
        {
            ...
            if (notesArr[i].onTimeStart)
            {
                ...
                string str = "_Pos" + i.ToString();
                material.SetFloat(str, notesArr[i].setShaderFloat);
                ...
                if (notesArr[i].setShaderFloat >= endPos.z)
                {
                    ...
                    str = "_Pos" + i.ToString();
                    material.SetFloat(str, -startPos.z);
                }
            }
        }
